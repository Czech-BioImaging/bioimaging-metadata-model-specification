...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sp="http://www.w3.org/2005/sparql-results#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" xmlns:c="https://schemas.dataspecer.com/xsd/core/">
  ...
  <xsl:template match="/sp:sparql">
    <xsl:for-each-group select="sp:results/sp:result[sp:binding[@name=$pred]/sp:uri/text()=$type and false()]" group-by="c:id-key(sp:binding[@name=$subj]/*[1])">
      <xsl:apply-templates select="current-group()[1]"/>
    </xsl:for-each-group>
  </xsl:template>
  <xsl:template match="sp:result[sp:binding[@name=$pred]/sp:uri/text()=$type and false()]">
    <specimen_>
      <xsl:call-template name="_https_003a_002f_002fofn.gov.cz_002fclass_002f1779194536554-13bd-7470-9778">
  ...
  <xsl:template name="_https_003a_002f_002fofn.gov.cz_002fclass_002f1779194536554-13bd-7470-9778">
    <xsl:param name="id"/>
