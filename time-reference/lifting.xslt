...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" xmlns:ccmm="https://schema.ccmm.cz/research-data/1.1" xmlns:c="https://schemas.dataspecer.com/xsd/core/" xmlns:ns0="http://www.w3.org/2006/time#" xmlns:ns1="https://model.ccmm.cz/vocabulary/ccmm#" xmlns:ns2="https://model.ccmm.cz/vocabulary/datacite#">
  <xsl:import href="https://model.ccmm.cz/research-data/time-reference/lifting.xslt"/>
  ...
  <xsl:template name="_fd449048-ce75-43e2-a8ba-c300bfc94c6e_002fclass-1762083331490-ea8b-4a3a-bd65">
    ...
    <rdf:Description>
        ...
        <ns0:hasTime>
          ...
          <xsl:choose>
            <xsl:when test="$type=node-name($types[1])">
              <xsl:call-template name="_9bb91d7b-ee59-4a31-910d-377ecd48d3a9_002fclass-1750713556573-db1c-483c-bcb7"/>
            </xsl:when>
            ...
            <xsl:when test="$type=node-name($types[2])">
              <xsl:call-template name="_8800b71c-8c68-4b1d-a0e0-577866f64d38_002fclass-1750713474658-dd87-9fe9-a4ab"/>
            </xsl:when>
      ...
      <xsl:for-each select="ccmm:date_type">
        <ns1:hasType>
          <xsl:call-template name="_1e04b3ba-377a-4e0c-a18b-9719afd94035_002fclass-1747684797448-9d6c-a945-a0af"/>
        </ns1:hasType>
      </xsl:for-each>
