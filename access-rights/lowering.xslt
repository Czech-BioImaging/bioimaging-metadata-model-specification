...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sp="http://www.w3.org/2005/sparql-results#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" xmlns:ccmm="https://schema.ccmm.cz/research-data/1.1" xmlns:c="https://schemas.dataspecer.com/xsd/core/">
  <xsl:import href="https://model.ccmm.cz/research-data/access-rights/lowering.xslt"/>
  ...
  <xsl:template match="/sp:sparql">
    <xsl:for-each-group select="sp:results/sp:result[sp:binding[@name=$pred]/sp:uri/text()=$type and sp:binding[@name=$obj]/sp:uri/text()=&#34;http://purl.org/dc/terms/RightsStatement&#34;]" group-by="c:id-key(sp:binding[@name=$subj]/*[1])">
  ...
  <xsl:template name="_06b19280-5dd0-4c08-84d5-1afa55aee122_002fclass-1747685414671-e5e1-7f82-b427">
    <xsl:param name="id"/>
